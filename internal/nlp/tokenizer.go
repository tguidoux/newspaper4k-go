...
const (
	// BertBaseUncasedVocabJSON is the JSON content of tokenizer.json
	// Content of tokenizer.json from https://huggingface.co/google-bert/bert-base-uncased/tree/main
	BertBaseUncasedVocabJSON = `
{
  "version": "1.0",
  "truncation": null,
  "padding": null,
...
// FromJSON constructs a new Tokenizer from json data (normally 'tokenizer.json')
func TokenizerFromJSON(jsonContent string) (*tokenizer.Tokenizer, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("creating Model failed: %v", err)
	}
...
func LocalBertBaseUncased() (*tokenizer.Tokenizer, error) {

	tk, err := TokenizerFromJSON(BertBaseUncasedVocabJSON)
	if err != nil {
		return nil, fmt.Errorf("creating Tokenizer from JSON failed: %v", err)
	}
